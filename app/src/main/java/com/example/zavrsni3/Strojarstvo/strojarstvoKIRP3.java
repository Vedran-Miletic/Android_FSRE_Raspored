...
public class strojarstvoKIRP3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo_kirp3);

        final ListView listView=(ListView) findViewById(R.id.stroj3kirpispis);
        ...
        Call<List<Termini>> call= api.getStr3KIRP();
