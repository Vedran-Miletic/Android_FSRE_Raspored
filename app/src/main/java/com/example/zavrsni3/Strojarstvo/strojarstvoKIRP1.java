...
public class strojarstvoKIRP1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo_kirp1);

        final ListView listView=(ListView) findViewById(R.id.strojKIRP1kirpispis);
        ...
        Call<List<Termini>> call= api.getStr4KIRP();
