...
public class strojarstvoKIRP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo_kirp2);

        final ListView listView=(ListView) findViewById(R.id.strojkirp2ispis);
        ...
        Call<List<Termini>> call= api.getStr5KIRP();
