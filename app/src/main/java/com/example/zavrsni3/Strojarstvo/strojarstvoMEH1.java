...
public class strojarstvoMEH1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo_meh1);

        final ListView listView=(ListView) findViewById(R.id.strojMEH1ispis);
        ...
        Call<List<Termini>> call= api.getStr4M();
