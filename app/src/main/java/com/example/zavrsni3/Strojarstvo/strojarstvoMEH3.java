...
public class strojarstvoMEH3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo_meh3);

        final ListView listView=(ListView) findViewById(R.id.stroj3mehispis);
        ...
        Call<List<Termini>> call= api.getStr3M();
