...
public class strojarstvoMEH2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo_meh2);

        final ListView listView=(ListView) findViewById(R.id.strojMEH2ispis);
        ...
        Call<List<Termini>> call= api.getStr5M();
