...
public class strojarstvo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo2);

        final ListView listView=(ListView) findViewById(R.id.stroj2ispis);
        ...
        Call<List<Termini>> call= api.getStr2();
