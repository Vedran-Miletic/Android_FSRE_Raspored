...
public class strojarstvo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strojarstvo1);

        final ListView listView=(ListView) findViewById(R.id.stroj1ispis);
        ...
        Call<List<Termini>> call= api.getStr1();
