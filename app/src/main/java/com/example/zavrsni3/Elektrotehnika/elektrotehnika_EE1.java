...
public class elektrotehnika_EE1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elektrotehnika__ee1);

        final ListView listView=(ListView) findViewById(R.id.ele4ee);
        ...
        Call<List<Termini>> call= api.getEle4EE();
