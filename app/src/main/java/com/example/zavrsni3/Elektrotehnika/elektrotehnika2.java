...
public class elektrotehnika2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elektrotehnika2);

        final ListView listView=(ListView) findViewById(R.id.ele2ispis);
        ...
        Call<List<Termini>> call= api.getEle2();
