...
public class racunarstvoRSIM2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racunarstvo_rsim2);

        final ListView listView=(ListView) findViewById(R.id.racRSIM2ispis);
        ...
        Call<List<Termini>> call= api.getRac5RSM();
