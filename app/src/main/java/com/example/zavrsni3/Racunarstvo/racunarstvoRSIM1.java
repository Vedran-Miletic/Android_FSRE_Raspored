...
public class racunarstvoRSIM1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racunarstvo_rsim1);

        final ListView listView=(ListView) findViewById(R.id.racRSIM1ispis);
        ...
        Call<List<Termini>> call= api.getRac4RSM();
