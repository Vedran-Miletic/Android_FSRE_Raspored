...
public class racunarstvoPIIS2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racunarstvo_piis2);

        final ListView listView=(ListView) findViewById(R.id.racPIIS2ispis);
        ...
        Call<List<Termini>> call= api.getRac5PIIS();
