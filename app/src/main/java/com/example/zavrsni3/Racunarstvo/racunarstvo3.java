...
public class racunarstvo3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racunarstvo3);

        final ListView listView=(ListView) findViewById(R.id.rac3ispis);
        ...
        Call<List<Termini>> call= api.getRac3();
