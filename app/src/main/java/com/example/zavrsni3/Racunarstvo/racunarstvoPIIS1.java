...
public class racunarstvoPIIS1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racunarstvo_piis1);

        final ListView listView=(ListView) findViewById(R.id.racPIIS1ispis);
        ...
        Call<List<Termini>> call= api.getRac4PIIS();
