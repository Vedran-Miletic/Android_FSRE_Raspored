...
public class racunarstvo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racunarstvo2);

        final ListView listView=(ListView) findViewById(R.id.rac2ispis);
        ...
        Call<List<Termini>> call= api.getRac2();
