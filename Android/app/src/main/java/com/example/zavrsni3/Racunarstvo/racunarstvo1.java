...
public class racunarstvo1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_racunarstvo1);

        final ListView listView=(ListView) findViewById(R.id.rac1ispis);
        ...
        Call<List<Termini>> call= api.getrac1();
        ...
        call.enqueue(new Callback<List<Termini>>() {
            ...
            public void onResponse(Call<List<Termini>> call, Response<List<Termini>> response) {
                ...
                String[] terminDatum =new String[termins.size()];
